...
class Kategori(models.Model):
    ...
    #     return super().save(*ar gs, **kwargs)
...
class Produk(models.Model):
    ...
    gambar_satu = models.ImageField(upload_to='gambar/banner', blank=True, null=True , verbose_name="Gambar (270 x 250 pixel)")
    gambar_dua = models.ImageField(upload_to='gambar/banner', blank=True, null=True , verbose_name="Gambar (270 x 250 pixel)")
    gambar_tiga = models.ImageField(upload_to='gambar/banner', blank=True, null=True , verbose_name="Gambar (270 x 250 pixel)")
    gambar_empat = models.ImageField(upload_to='gambar/banner', blank=True, null=True , verbose_name="Gambar (270 x 250 pixel)")
    gambar_lima= models.ImageField(upload_to='gambar/banner', blank=True, null=True , verbose_name="Gambar (270 x 250 pixel)")
